...
from DIEN_Demo.rnn import dynamic_rnn

from DIEN_Demo.utils import prelu,din_fcn_attention,dice
from DIEN_Demo.vecAttGruCell import VecAttGRUCell
...
class Model(object):
    def __init__(self,n_uid, n_mid, n_cat, EMBEDDING_DIM, HIDDEN_SIZE, ATTENTION_SIZE, use_negsampling = False):
        ...
        if self.use_negsampling:
            ...
            self.noclk_his_eb_sum_1 = tf.reduce_sum(self.noclk_his_eb, 2) # 负采样主要是为了计算辅助损失
    ...
    def auxiliary_loss(self,h_states,click_seq,noclick_seq,mask,stag=None):
        # 辅助损失函数，主要是对应论文，利用点击和未点击分别来进行二分类，从而构造辅助损失。
