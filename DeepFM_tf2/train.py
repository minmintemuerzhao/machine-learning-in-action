...
from DeepFM_tf2.criteo import create_criteo_dataset
...
if __name__ == '__main__':
    ...
    dense_features = ['I1', 'I2', 'I3', 'I4', 'I5', 'I6', 'I7', 'I8', 'I9',
                      ...
                      'I12', 'I13']
    # ========================== Create dataset =======================
    features_columns, train, test = create_criteo_dataset(
    ...
    with mirrored_strategy.scope():
        model = DeepFM(features_columns, hidden_units=hidden_units,
        ...
        model.compile(loss=binary_crossentropy,
                      ...
                      metrics=[AUC()])
    # ============================model checkpoint======================
    # check_path = '../save/deepfm_weights.epoch_{epoch:04d}.val_loss_{
    # val_loss:.4f}.ckpt'
